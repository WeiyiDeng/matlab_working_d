...
function [LL, gr, H] = band_bi_ll_past_year_ratio(b,IVs,trend_hat, pop_ratio, dummy_agg_SI, None0s_X_N, S, choice_dv)
global dummies se
...
FV = [IVs(:,1)  trend_hat  week_IV  week_IV.^2   pop_ratio   week_IV.*pop_ratio      week_IV.^2.*pop_ratio     IV_N_S]*b_basic;          % with both trend and BP as controls
