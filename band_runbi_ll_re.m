% function [b, hessian, standard_error, covariance_matrix, t_stat, exit_flag] = band_runbi_ll_re(X, y, beta_0)
function [b, hessian, standard_error, covariance_matrix, t_stat, exit_flag] = band_runbi_ll_re(beta_0)
...
[b, fval,exitflag,output,grad,hessian] = fminunc(@band_bi_ll_re,beta0,options);
