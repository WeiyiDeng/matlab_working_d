...
function [LL, gr, H] = band_bi_ll_trend_reverse_agg_dummy_SI_square_pop_y(b,IVs,trend_hat, pop, dummy_agg_SI, None0s_X_N, S, choice_dv)
global dummies se
...
FV = [IVs(:,1)  trend_hat  week_IV  week_IV.^2   pop   week_IV.*pop      week_IV.^2.*pop     IV_N_S]*b_basic;          % with both trend and BP as controls
