...
% save('dummies30.mat','dummies30','-v7.3');
% save('dummies40.mat','dummies40','-v7.3');
...
load('dummies30.mat');
% size(dummies30)
dummies30 = dummies30(index,:);
dummies_prep = dummies30.*repmat(matp(:,8),1,4);
clearvars dummies30
...
beta_0 = [-7.5284     0.0423     0.1    1    1    1    1    0.0339    2.0197    2.0455]

[b, hessian, grad, standard_error, covariance_matrix, t_stat, exit_flag, output] = band_runbi_ll_trend_reverse_dummies30(X, dummies_prep, trend_hat, None0s_X_N, S, y, beta_0);

save('b_dummies30.mat','b') ;
save('standard_error_dummies30.mat','standard_error') ;
save('t_stat_dummies30.mat','t_stat') ;
save('exit_flag_dummies30.mat','exit_flag') ;
