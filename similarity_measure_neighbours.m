...
user_dyad = csvread('neighbourlist_6585.csv',1,0);
...
save('Cosine_similarity_scores_ind_neighbours6585_listen1.mat','Cosine_similarity_scores_ind', '-v7.3');
save('Cosine_similarity_scores_neighbours6585_listen1.mat','Cosine_similarity_scores', '-v7.3');
save('Cosine_user_uv_ind_neighbours6585_listen1.mat','Cosine_user_uv_ind', '-v7.3');
