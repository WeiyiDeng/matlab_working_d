...
function [LL, gr, H] = band_bi_ll_trend_reverse_dummiesSI_main(b,IVs,trend_hat, band_age, topics_count, dummy_prep, None0s_X_N, S, choice_dv)
global dummies se
...
FV = [IVs(:,1)  trend_hat  week_IV  band_age  topics_count    IV_N_S]*b_basic;          % with both trend and BP as controls
