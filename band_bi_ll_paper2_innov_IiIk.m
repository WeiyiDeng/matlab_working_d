...
function [LL, gr, H] = band_bi_ll_paper2_innov_IiIk(b,IVs,trend_hat, pop, dummy_agg_SI, mat_sparse_8088, m_innov, f_innov, cosine_similarity_scores, None0s_X_N, S, choice_dv)
global dummies se
...
FV = [Aijkt*(m_innov.*Sik)    Aijkt*(f_innov.*Sik)    Aijkt*(f_innov.*m_innov.*Sik)     Aijkt*Sik    IV_N_S]*b_basic;
