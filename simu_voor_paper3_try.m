...
load('simu_sample_noSI.mat')
prep_paper3_fix = [matp_mjt prep_SI_pop_paper3 simu_sample_noSI];          % Simulated DV of paper 3 stage 1 !
...
prep_paper3_fix_paper1_DV_cut10_simuKort = prep_paper3_fix_paper1_DV_cut10(:,1:2);

clearvars -EXCEPT prep_paper3_fix_move_agg10 prep_paper3_fix_paper1_DV_cut10_simu

csvwrite('prep_paper3_fix_paper1_DV_cut10_simuKort.csv',prep_paper3_fix_paper1_DV_cut10_simuKort)
