...
%%
save('Cosine_similarity_ind_job6.mat','Cosine_similarity_scores_ind', '-v7.3');
save('Cosine_similarity_scores_job6.mat','Cosine_similarity_scores', '-v7.3');
save('Cosine_user_uv_ind_job6.mat','Cosine_user_uv_ind', '-v7.3');
