...
quantile(week_IV(week_IV>0),0.995)       % 10
...
legend({'high pop','median pop','low pop'},'Location','northwest')
hold off
xlabel('Social influence (number of friends sampling a new band b)') 
...
hist(count_friends(count_friends(:,2)<600,2),30);
...
%%
y = [50 0 60 0 60 0 56 0 40 0 40];
% bar(y)
bar(y,'FaceColor',[0.211 0.211 0.211],'EdgeColor',[1 1 1],'LineWidth',1.5)
ylim([0 70])
xlabel('Major music platforms') 
ylabel('Number of songs (millions)')
set(gca,'xticklabel',{'Spotify';'';'Apple Music';'';'Amazon Music';'';'Deezer';'';'Google Play Music';'';'Pandora'},'FontSize', 7)
