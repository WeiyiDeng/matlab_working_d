...
save('b_agg_dummy_pop.mat','b') ;
save('standard_error_agg_dummy_pop.mat','standard_error') ;
save('t_stat_agg_dummy_pop.mat','t_stat') ;
save('exit_flag_agg_dummy_pop.mat','exit_flag') ;
save('hessian_pop.mat','hessian') ;
