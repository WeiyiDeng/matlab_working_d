...
function [b, hessian, grad, standard_error, covariance_matrix, t_stat, exit_flag, output] = band_runbi_ll_reverse_N(X, X_N, None0s_X_N, S, y, beta_0)
...
[b, fval,exitflag,output,grad,hessian] = fminunc(@band_bi_ll_reverse_N,beta0,options,IVs, X_N, None0s_X_N, S, choice_dv);
