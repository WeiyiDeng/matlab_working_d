...
function [LL, g, H] = band_bi_ll_trend_reverse_N_age_diverse_11fix1(b,IVs,trend_hat, band_age, topics_count, X_N, None0s_X_N, S, choice_dv, beta_fix)
global dummies se
...
FV = [IVs(:,1) trend_hat week_IV  band_age  topics_count  IV_N_S...
    band_age.*week_IV]*[b_basic; b'];          % with both trend and BP as controls
...
g(1) = (band_age.*week_IV)'*(prob-choice_dv(:,1));
