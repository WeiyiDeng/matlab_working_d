...
beta_0 = [-7.5284    0.0423    1    1    1    1    0.0339    2.0197    2.0455]

[b, hessian, grad, standard_error, covariance_matrix, t_stat, exit_flag, output] = band_runbi_ll_trend_reverse_dummies40(X, dummies_prep, trend_hat, None0s_X_N, S, y, beta_0);

save('b_dummies40.mat','b') ;
save('standard_error_dummies40.mat','standard_error') ;
save('t_stat_dummies40.mat','t_stat') ;
save('exit_flag_dummies40.mat','exit_flag') ;
