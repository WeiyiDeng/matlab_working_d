...
norm_weeks_diff = gampdf(diff_weeks,1,6);
...
options = optimset('disp','iter','LargeScale','on','GradObj','on','Hessian','off','DerivativeCheck','off', 'Jacobian', 'on','TolFun',1e-9, 'MaxIter',1e3, 'MaxFunEvals', 1e6, 'TolX',1e-14)         % LargeScale off is quasi-Newton method in optimset
...
[b, fval,exitflag,output, grad,hessian] = fminunc(@log_likelihood_try_f2,b0,options,DV,IV,I,P);
