...
function [LL, gr, H] = band_bi_ll_trend_reverse_N_age_diverse14(b,IVs,trend_hat, band_age, topics_count, X_N, None0s_X_N, S, choice_dv)
global dummies se
...
week_IV = 100*gampdf(IVs(:,2),1.25,exp(b(2)));
week_IV(IVs(:,3)==0)=0;
