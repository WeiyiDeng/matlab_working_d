...
function [b, hessian, grad, standard_error, covariance_matrix, t_stat, exit_flag, output] = band_runbi_ll_tag_pop(X, trend_hat, pop, dummy_agg_SI, None0s_X_N, S, y, beta_0)
...
[b, fval,exitflag,output,grad,hessian] = fminunc(@band_bi_ll_tag_pop,beta0,options,IVs, trend_hat, pop, dummy_agg_SI, None0s_X_N, S, choice_dv);
