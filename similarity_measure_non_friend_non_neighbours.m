...
save('Cosine_similarity_scores_ind_non_friends_new_listens_TFIDF.mat','Cosine_similarity_scores_ind', '-v7.3');
save('Cosine_similarity_scores_non_friends_new_listens_TFIDF.mat','Cosine_similarity_scores', '-v7.3');
save('Cosine_user_uv_ind_non_friends_new_listens_TFIDF.mat','Cosine_user_uv_ind', '-v7.3');
