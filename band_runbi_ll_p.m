function [b, hessian, grad, standard_error, covariance_matrix, t_stat, exit_flag] = band_runbi_ll_p(X, y, beta_0)
...
options = optimset('Display','iter','LargeScale','off','GradObj','off','Hessian','off','TolFun',1e-7, 'MaxIter',1e4, 'MaxFunEvals', 1e5);
