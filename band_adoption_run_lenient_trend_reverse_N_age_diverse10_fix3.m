...
beta_fix = [-5.0956    0.1766    2.0276    0.0401      0.0671    0.0176       -0.0065      -0.2234       0.0153         1.0260      1.0120]
% Age*new_week_diff     Diversity*new_week_diff(10)     Diversity*Age    Diversity*Age*new_week_diff
beta_0 = [0.1   0.1   0.1  0.1]

[b, hessian, grad, standard_error, covariance_matrix, t_stat, exit_flag, output] = band_runbi_ll_trend_reverse_N_age_diverse_fix3(X, trend_hat, band_age, topics_count, X_N, None0s_X_N, S, y, beta_0, beta_fix);
