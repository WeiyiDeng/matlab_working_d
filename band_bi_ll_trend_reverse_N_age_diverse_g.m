...
function [LL, g, H] = band_bi_ll_trend_reverse_N_age_diverse_g(b,IVs,trend_hat, band_age, topics_count, X_N, None0s_X_N, S, choice_dv)
global dummies se
...
disp(g')
assert(length(g)<1, 'Check point for gradient values');
