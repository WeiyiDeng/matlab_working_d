...
save('b_agg_dummy_pop_re.mat','b') ;
save('standard_error_agg_dummy_pop_re.mat','standard_error') ;
save('t_stat_agg_dummy_pop_re.mat','t_stat') ;
save('exit_flag_agg_dummy_pop_re.mat','exit_flag') ;
save('hessian_pop_re.mat','hessian') ;
