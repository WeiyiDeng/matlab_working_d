...
function [LL, g, H] = band_bi_ll_trend_reverse_N_age_diverse_fix3(b,IVs,trend_hat, band_age, topics_count, X_N, None0s_X_N, S, choice_dv, beta_fix)
global dummies se
...
g(1:4) = [band_age.*week_IV  topics_count.*week_IV   band_age.*topics_count...
    band_age.*topics_count.*week_IV]'*(prob-choice_dv(:,1));
