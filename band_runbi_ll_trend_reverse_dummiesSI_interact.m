...
function [b, hessian, grad, standard_error, covariance_matrix, t_stat, exit_flag, output] = band_runbi_ll_trend_reverse_dummiesSI_interact(X, trend_hat, band_age, topics_count, dummy_prep, None0s_X_N, S, y, beta_0)
...
[b, fval,exitflag,output,grad,hessian] = fminunc(@band_bi_ll_trend_reverse_dummiesSI_interact,beta0,options,IVs, trend_hat, band_age, topics_count, dummy_prep, None0s_X_N, S, choice_dv);
