...
predict_trend = csvread('predict_trend_log4061.csv',1,0);       % reads from row 2 of the doc
...
save('matp_trend_rm_all_member_strict.mat','matp','-v7.3');
