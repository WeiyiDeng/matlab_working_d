...
% time period + squared choices + way to draw from truncated normal
...
for t=1:T
    for i=1:I
        ...
        utility=exp(b(1)+b(2)*features(t,:,i)+b(3)*total_choices{i}+b(4)*total_choices_of_friends{i}+b(5)*(total_choices{i}).^2);    %1XJ
