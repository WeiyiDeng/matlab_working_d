...
function [LL, gr, H] = band_bi_ll_x6_pop_y_noBP_rmSI_addPOP(b,IVs,trend_hat, pop, dummy_agg_SI, None0s_X_N, S, choice_dv)
global dummies se
...
FV = [trend_hat  week_IV  week_IV.^2  IV_N_S]*b_basic; 
