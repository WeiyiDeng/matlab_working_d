...
function [LL, gr, H] = band_bi_ll_trend_reverse_N_age_diverse_fix(b,IVs,trend_hat, band_age, topics_count, X_N, None0s_X_N, S, choice_dv, beta_fix)
global dummies se
...
val_pdf = 100*normpdf(None0s_X_N(:,3),0,beta_fix(10));
