...
function [b, hessian, grad, standard_error, covariance_matrix, t_stat, exit_flag, output] = band_runbi_ll_trend_reverse_agg_dummy_SI_square_main_0SI(X, trend_hat, pop, dummy_agg_SI, None0s_X_N, S, y, beta_0)
...
[b, fval,exitflag,output,grad,hessian] = fminunc(@band_bi_ll_trend_reverse_agg_dummy_SI_square_main_0SI,beta0,options,IVs, trend_hat, pop, dummy_agg_SI, None0s_X_N, S, choice_dv);
