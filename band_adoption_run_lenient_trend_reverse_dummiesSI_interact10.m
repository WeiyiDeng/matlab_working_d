...
save('b_dummy10.mat','b') ;
save('standard_error_dummy10.mat','standard_error') ;
save('t_stat_dummy10.mat','t_stat') ;
save('exit_flag_dummy10.mat','exit_flag') ;
