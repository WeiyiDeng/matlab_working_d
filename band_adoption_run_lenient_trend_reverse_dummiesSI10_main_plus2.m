...
clearvars dummies40
dummy_prep = dummies_prep(:,1);         % 1-10
...
%         intercept baseline_prob gtrend(5) new_week_diff  band_age  topics_count     Age*new_week_diff    Diversity*new_week_diff     week_diff_coef_n  normal_sd   similarity_coef
beta_0 = [-6.9490       0.0366    0.3435       0.3486      -0.0033     -0.0104         -0.0005                0.001                      0.0337            2.0827       1.9961]
clearvars b

[b, hessian, grad, standard_error, covariance_matrix, t_stat, exit_flag, output] = band_runbi_ll_trend_reverse_dummiesSI_main_plus2(X, trend_hat, band_age, topics_count, dummy_prep, None0s_X_N, S, y, beta_0);

save('b_dummy10_mainplus2.mat','b') ;
save('standard_error_dummy10_mainplus2.mat','standard_error') ;
save('t_stat_dummy10_mainplus2.mat','t_stat') ;
save('exit_flag_dummy10_mainplus2.mat','exit_flag') ;
