...
% beta_0 = b
beta_0 = [-7.7250    0.0443    0.3302    0.0686   0.001    0.0341    2.1842   0.7598]
% clearvars b

% pop = topics_count;              % topics

[b, hessian, grad, standard_error, covariance_matrix, t_stat, exit_flag, output] = band_runbi_ll_trend_reverse_agg_dummy_SI_square_main(X, trend_hat, pop, dummy_agg_SI, None0s_X_N, S, y, beta_0);

save('b_agg_dummy_main.mat','b') ;
save('standard_error_agg_dummy_main.mat','standard_error') ;
save('t_stat_agg_dummy_main.mat','t_stat') ;
save('exit_flag_agg_dummy_main.mat','exit_flag') ;
save('hessian_main.mat','hessian') ;
