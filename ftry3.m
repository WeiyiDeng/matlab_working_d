...
% innov_intv_m = quantile([uni_innov_m' uni_innov_f'],1:1:100)
% innov_intv_f = innov_intv_m
% explor_intv_m = quantile([uni_explor_m' uni_explor_f'],1:1:100)
% explor_intv_f = explor_intv_m
...
% innov_intv_m = exp(innov_intv_m);
% innov_intv_f = exp(innov_intv_f);
% explor_intv_m = exp(explor_intv_m);
% explor_intv_f = exp(explor_intv_f);

% A = -1.7694:0.1:10.0343;
% B = -0.9380:0.1:7.5189;
% innov_intv_m = -1.7694:0.1:10.0343;
% innov_intv_f = -1.7267:0.1:10.0343;
% explor_intv_m = -0.9380:0.1:7.5189;
% explor_intv_f = -0.9380:0.1:7.5189;

% innov_intv_m = -1:0.05:1;
% innov_intv_f = -1:0.05:1;
% explor_intv_m = -1:0.05:1;
% explor_intv_f = -1:0.05:1;
