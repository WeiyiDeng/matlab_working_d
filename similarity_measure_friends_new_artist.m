...
friend_listens = csvread('test_fm_artist_id.csv',1,0);
neigh_listens = [];
...
save('Cosine_similarity_scores_ind_friend_new_artist_listen1_TFIDF.mat','Cosine_similarity_scores_ind', '-v7.3');
save('Cosine_similarity_scores_friend_new_artist_listen1_TFIDF.mat','Cosine_similarity_scores', '-v7.3');
save('Cosine_user_uv_ind_friend_new_artist_listen1_TFIDF.mat','Cosine_user_uv_ind', '-v7.3');
