...
% of whole market share + way to draw from multivariate normal
...
% b = exp(rand(4,J))
beta1 = exp(randn(I,J))
beta2 = exp(randn(I,J)).*1
beta3 = exp(randn(I,J)).*0.01
beta4 = exp(randn(I,J)).*0.005
