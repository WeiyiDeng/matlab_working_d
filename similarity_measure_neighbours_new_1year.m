...
neigh_listens = csvread('test_nm_id_1year.csv',1,0);
...
% save('Cosine_similarity_scores_ind_6585.mat','Cosine_similarity_scores_ind', '-v7.3');
% save('Cosine_similarity_scores_6585.mat','Cosine_similarity_scores', '-v7.3');
% save('Cosine_user_uv_ind_6585.mat','Cosine_user_uv_ind', '-v7.3');
