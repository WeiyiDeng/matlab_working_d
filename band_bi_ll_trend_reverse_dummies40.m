...
function [LL, gr, H] = band_bi_ll_trend_reverse_dummies40(b,IVs,dummies_prep,trend_hat, None0s_X_N, S, choice_dv)
global dummies se
...
FV = [IVs(:,1) trend_hat week_IV  IV_N_S]*b_basic;          % with both trend and BP as controls
