...
% mod_Traindata = [IV1 IV2 IV3 IV4 IV5 IV6 Respondent_mat choice_dv];
% csvwrite('mod_data.csv',mod_Traindata);
...
% [beta_0, fval,exitflag,output,grad,hessian] = fminunc(@simp_ll_test2_Train_data,b0,options);
