...
% beta_0 = b
% beta_0 = [-7.7250    0    0    0.01    0.01    0.01    0.01    0    2.1842   0.7598   1]
beta_0 = [-7.7742    0.0575   -0.0304   -0.0406   -0.1937    1.2697    0.3480    0.0487    2.2752   0.4287   -10]
% beta_0 = [-7.7250    0    0    0.01    0.01    0.01    0.01    0    2.1842   0.7598]
% beta_0 = [-7.7250    0.01    0.01    0.01    0    0    2.1842   0.7598]
clearvars b

[b, hessian, grad, standard_error, covariance_matrix, t_stat, exit_flag, output] = band_runbi_ll_paper2_innov_IiIk6(X, trend_hat, pop, dummy_agg_SI, mat_sparse_8088, m_innov, f_innov, Im_17617085, Ik_17617085, cosine_similarity_scores, None0s_X_N, S, y, beta_0);
