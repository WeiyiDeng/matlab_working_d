...
% explor_intv_f = explor_intv_m;
innov_intv_m = quantile([uni_innov_m' uni_innov_f'],0.01:0.03:0.99)
innov_intv_f = innov_intv_m
explor_intv_m = quantile([uni_explor_m' uni_explor_f'],0.01:0.03:0.99)
explor_intv_f = explor_intv_m
...
surf(innov_intv_m, innov_intv_f, squeeze(sub_prob))
xlabel('innov_m')
ylabel('innov_f')
