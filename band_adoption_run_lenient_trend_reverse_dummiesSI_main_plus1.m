...
%         intercept baseline_prob gtrend(5) new_week_diff  band_age  topics_count     Age*new_week_diff    week_diff_coef_n  normal_sd   similarity_coef
beta_0 = [-7.0387    0.0368        0.3433      0.3         -0.0034      -0.0035          0.01                  0.0337            2.0827       1.9961]
clearvars b

[b, hessian, grad, standard_error, covariance_matrix, t_stat, exit_flag, output] = band_runbi_ll_trend_reverse_dummiesSI_main_plus1(X, trend_hat, band_age, topics_count, dummy_prep, None0s_X_N, S, y, beta_0);

save('b_dummy20_mainplus1.mat','b') ;
save('standard_error_dummy20_mainplus1.mat','standard_error') ;
save('t_stat_dummy20_mainplus1.mat','t_stat') ;
save('exit_flag_dummy20_mainplus1.mat','exit_flag') ;
