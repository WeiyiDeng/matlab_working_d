...
%%
beta_0 = [-7.7250    0.0443    0.3302    0.0686   0.01    0.01    0.01    0.01    0.0341    2.1842   0.7598]
clearvars b

[b, hessian, grad, standard_error, covariance_matrix, t_stat, exit_flag, output] = band_runbi_ll_trend_reverse_agg_dummy_SI_pop(X, trend_hat, pop, dummy_agg_SI, None0s_X_N, S, y, beta_0);
