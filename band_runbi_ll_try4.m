function [b, hessian, grad, standard_error, covariance_matrix, t_stat, exit_flag, output] = band_runbi_ll_try4(X, y, beta_0)
...
[b, fval,exitflag,output,grad,hessian] = fminunc(@band_bi_ll_try4,beta0,options,IVs,choice_dv);
