...
function [b, hessian, grad, standard_error, covariance_matrix, t_stat, exit_flag, output] = band_runbi_ll_i0_0(X, y, beta_0, innov_IV, explor_IV)
% function [b, hessian, grad, standard_error, covariance_matrix, t_stat, exit_flag, output] = band_runbi_ll_i0_0(X, y, beta_0, innov_WD_multip, explor_WD_multip, prev_innov_IV, prev_explor_IV)
...
% [b, fval,exitflag,output,grad,hessian] = fminunc(@band_bi_ll_i0_0,beta0,options,IVs,choice_dv, innov_WD_multip, explor_WD_multip, prev_FV_WD, prev_innov_IV, prev_explor_IV);
[b, fval,exitflag,output,grad,hessian] = fminunc(@band_bi_ll_i0_0,beta0,options,IVs,choice_dv, innov_IV, explor_IV, prev_FV);
