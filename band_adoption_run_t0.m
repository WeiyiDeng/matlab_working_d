...
beta_0 = [beta_0         -0.0159   -0.0046    0.0028    0.0005    0.0052   -0.0014]
% beta_0 = [beta_0         -0.0090    0.0092    -0.0145    0.0017];
% beta_0 = [beta_0        -0.0159   -0.0046    0.0028    0.0005]

% beta_0 = [beta_0         -0.0564    0.0017   -0.1336    0.0423   -0.0423   -0.0117    -0.0752    0.0117];  
% beta_0 = [beta_0          0 0 0 0 0 0 0 0];
% % beta_0 = [beta_0         0 0 0 0 0 0 0 0]
% beta_0 = [beta_0         0 0 0 0]
...
[b, hessian, grad, standard_error, covariance_matrix, t_stat, exit_flag, output] = band_runbi_ll_t0(X, y, beta_0, innov_X, explor_X);
