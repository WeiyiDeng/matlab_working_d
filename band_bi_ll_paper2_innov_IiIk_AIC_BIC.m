...
function [LL, gr, H] = band_bi_ll_paper2_innov_IiIk_AIC_BIC(b,IVs,trend_hat, pop, dummy_agg_SI, mat_sparse_8088, m_innov, f_innov, Im_17617085, Ik_17617085, cosine_similarity_scores, None0s_X_N, S, choice_dv)
global dummies se
...
FV = [Im_17617085    Ik_17617085     Aijkt*Sik_power     IV_N_S]*b_basic;
