...
function [b, hessian, grad, standard_error, covariance_matrix, t_stat, exit_flag, output] = band_runbi_ll_trend_reverse_dummies40(X, dummies_prep, trend_hat, None0s_X_N, S, y, beta_0)
...
[b, fval,exitflag,output,grad,hessian] = fminunc(@band_bi_ll_trend_reverse_dummies40,beta0,options,IVs, dummies_prep, trend_hat, None0s_X_N, S, choice_dv);
