...
save('Cosine_similarity_scores_ind_new_friends_withTFIDF.mat','Cosine_similarity_scores_ind', '-v7.3');
save('Cosine_similarity_scores_new_friends_withTFIDF.mat','Cosine_similarity_scores', '-v7.3');
save('Cosine_user_uv_ind_new_friends_withTFIDF.mat','Cosine_user_uv_ind', '-v7.3');
