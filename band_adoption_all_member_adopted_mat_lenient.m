...
save('matp_member_all_lenient.mat','matp', '-v7.3') ;
...
load('matp_member_all_lenient.mat');
...
save('matpstd2_all_member_lenient.mat','matp','-v7.3');
clearvars matp

load('innov_contin2_all_member_lenient.mat');
innov_m = innov_contin(:,1);
innov_f = innov_contin(:,3);
% innov_m = (innov_m-mean(innov_m))./std(innov_m);
% innov_f = (innov_f-mean(innov_f))./std(innov_f);
...
save('innov_contin_std2_all_member_lenient.mat','innov_contin','-v7.3');
clearvars innov_contin

load('explor_contin2_all_member_lenient.mat');
explor_m = explor_contin(:,1);
explor_f = explor_contin(:,3);
% explor_m = (explor_m-mean(explor_m))./std(explor_m);
% explor_f = (explor_f-mean(explor_f))./std(explor_f);
...
save('explor_contin_std2_all_member_lenient.mat','explor_contin','-v7.3');
